...
public class Main {
    ...
    private static int clienteIdCounter = 1; // Contador para IDs de clientes
    ...
    public static void main(String[] args) {
        ...
        while (!exit) {
            ...
            if (!scanner.hasNextInt()) {
                ...
                scanner.next(); // Descarta el input no válido
                continue;
            }
    ...
    private static void gestionarClientes(Scanner scanner) {
        ...
        switch (opcion) {
            case 1:
                ...
                Cliente cliente = new Cliente(clienteIdCounter++, nombre);
        ...
        switch (opcion) {
            case 1:
                ...
                if (!scanner.hasNextDouble()) {
                    System.out.println("Por favor ingrese un costo válido.");
                    scanner.next(); // Descarta el input no válido
                    return;
                }
